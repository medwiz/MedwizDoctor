...
class ClinicDetailsFragment:Fragment(R.layout.fragment_add_clinic_details) {
   ...
   private var clinicTimingList:ArrayList<ClinicTiming> = ArrayList<ClinicTiming>()
    ...
    private fun showDialog() {
        ...
        val dayList = arrayOf("Select Day","Sunday","Monday", "Tuesday", "Wednesday","Thursday","Friday","Saturday")
        ...
        mTimePicker = TimePickerDialog(requireContext(), object : TimePickerDialog.OnTimeSetListener {
            override fun onTimeSet(view: TimePicker?, hourOfDay: Int, minute: Int) {
                strTime=MedWizUtils.getTime(hourOfDay,minute).toString()//String.format("%d : %d", hourOfDay, minute)
                if(textView!=null){
        ...
        dialogBinding.btAdd.setOnClickListener {
            ...
            if(strDay.isEmpty()||strDay=="Select Day"){
                MedWizUtils.showToast(requireContext(),"Please Select day")
            ...
            val clinicTiming=ClinicTiming(strDay,morningStart,morningEnd,
